...
With a `wolf` resolving — re-measured 2026-09-17 at pin `2e4ca76` (tl09)
against the **acquired** v0.2.15 linux x86_64 artifact in `.wolf-bin/`, not a
local build, as tl07 did at v0.2.14 and tl02 at v0.2.12 — step 3b stops being
pending and gets checked, so the same tree prints:
